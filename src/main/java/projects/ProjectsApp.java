...
import projects.execptions.DbException;
...
public static void main(String[] args) {
		new ProjectsApp().processUsersSelection();
	...
	/**
     * This method prints the operation and get user menu selection
     */

    
    private void processUsersSelection() {
        boolean done = false;
